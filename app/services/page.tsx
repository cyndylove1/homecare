...
import { HeartPulse, Stethoscope, Brain, Bone, Activity } from "lucide-react";
...
const Services = () => {
  ...
  return (
    <>
      ...
      <Banner title="Our Services" currentPage="Services" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 flex flex-col items-center">
            ...
            <p className="text-slate-500 md:text-md text-sm max-w-2xl leading-relaxed">
              Renowned for innovations in geriatric care, personal assistance,
              and medical monitoring, our agency provides a full suite of
